...
class MultiFMacroApp:
    ...
    def _build_fishing_tab(self):
        ...
        FS_ZIP_URL = "https://github.com/pws32z/MultiFMacro/releases/download/V3.6/FishScope-Macro-2.4-Beta3.zip"
        ...
        def _launch():
            ...
            if getattr(sys, "frozen", False):
                ...
                if found: python = found
                    ...
                    self._fish_status_var.set("python.exe not found — add Python to PATH")
                    self._fish_status_lbl.configure(fg=ACC3); return
            try:
    ...
    def _ocr_read_chat_text(self, save_debug=False):
        ...
        try:
            # Always use hardcoded bbox — reliable on 1080p regardless of scan
            x0, y0, x1, y1 = 0, 50, 470, 400
            print(f"[ChatOCR] using hardcoded bbox: ({x0},{y0})→({x1},{y1})")
